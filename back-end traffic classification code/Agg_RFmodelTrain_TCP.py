...
if __name__ == '__main__':
    filtTag='1TD'  #'1TD' '2TS'
    dataPath1 = "./dataSet/newSketchPool/train/"+filtTag+".csv"  #聚类原材料sketch出来的原特征文件
    ChunkSizeMy1 = 20000       #块大小 tcp:20000  udp:2000
    ...
    print("|----------------------------------------启动聚类主函数！（本次聚类流量信息：type=" + filtTag + "; blockSize=20,000）----------------------------------------|")
    ...
    print("|----------------------------------------批量聚类已完成！（本次聚类流量信息：type=" + filtTag + "; blockSize=20,000）----------------------------------------|")
